...
def SolicitarCumpleanos():
   while (True):
        try: 
            cumpleanos=[]
            dia = input("Ingrese el dia del cumple plz: ")
            mes = input("Ingrese el mes del cumple plz: ")
            anos = input("Ingrese el año del cumple plz: ")
            if dia in range(1, 31):
                cumpleanos.append(dia)
            elif mes in range(1, 12):                
                cumpleanos.append(mes)
            elif anos in range(1940, 2005):                
